...
const weatherCode2Type = (weatherCode) => {
  console.log(weatherCode, "in weatherCode2Type");
  const [weatherType] =
...
export function WeathcerIcon({ moment, currentWeatherCode }) {
  console.log(currentWeatherCode, "--- involke WeatherIconCom ---");
  console.log(moment);
  ...
  useEffect(() => {
    console.log("in useEffect from WeatherIcon");
